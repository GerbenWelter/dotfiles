...
require("packer").startup(function(use)
	...
	use({
		...
		cond = vim.fn.empty(vim.fn.glob(vim.fn.stdpath("data") .. "/site/pack/packer/start/nvim-treesitter")) == 0,
	})
	...
	use({
		...
		cond = {
			...
			vim.fn.empty(vim.fn.glob(vim.fn.stdpath("data") .. "/site/pack/packer/start/packer.nvim")) == 0,
		},
	})
